    ...
    <main>
        ...
        <div id="content">
            <div id="box">
                ...
                <?php
                $sql = "SELECT * FROM `1v1bet` WHERE `username` = '$username' ";
                $result = mysqli_query($con, $sql);
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        if ($row[7] == 1) {
                            echo "<span style='color: yellow;'>Active Now</span>";
                        } elseif ($row[7] == 0) {
                ...
                <?php
                $sql = "SELECT * FROM `2v2bet` WHERE `username` = '$username' ";
                $result = mysqli_query($con, $sql);
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_array($result)) {
                        echo "
                ...
                <?php
                $sql = "SELECT * FROM `multiplayerbet` WHERE `username` = '$username' ";
                $result = mysqli_query($con, $sql);
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_array($result)) {
                        echo "
                ...
                <?php
                $sql = "SELECT * FROM `scorebet` WHERE `username` = '$username'  ";
                $result = mysqli_query($con, $sql);
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_array($result)) {
                        echo "
                ...
                <?php
                $sql = "SELECT * FROM `tossbet` WHERE `username` = '$username' ";
                $result = mysqli_query($con, $sql);
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_array($result)) {
                        echo "
