                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="container1" id="formbox">
                        ...
                        <form action="addmanager.php" method="post">
                            ...
                            <br>
                            <input type="submit" name="submit" value="Add New Manager" class="btn btn-success">
                    ...
                    <div class="container1" id="result">
                        <p id="resultText">
                            ...
                            if (isset($_COOKIE["text"])) {
                                echo $_COOKIE["text"];
                                echo '<a href="addmanager.php?delete=true" class="btn btn-success">Ok</a>';
                            }
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `manager`( `email`, `password`, `name`, `status`, `credits`) 
    VALUES ('$email','$password','$name','1','$credits')";
