                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            echo "
                                    <form action='editmanager.php' method='post'>
                                        ...
                                        <label>Name</label>
                                        <input type='text' value='$row[3]' placeholder='Sport Name' name='name' class='form-control' required>
                                        <br>
                                        <label>Eamil</label>
                                        <input type='text' value='$row[1]'  class='form-control' disabled>
                                        <br>
                                        <label>Credits</label>
                                        <input type='number' value='$row[5]'  placeholder='credits' name='credits' class='form-control' required>
                                        <br>
                                        <label>Status</label>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `manager` SET `name`='$name',`credits`='$credits',`status`='$status' WHERE `id` = '$id' ";
