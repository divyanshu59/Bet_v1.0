                        ...
                        <p id="resultText">
                            ...
                            if (isset($_GET['added'])) {
                               ...
                               <h3 class='text-success'>Multiplayer Game Added! </h3>
                                ";
                                echo '<a href="multiplayer.php" class="btn btn-success">Ok</a>';
                            }
                            ?>
                        </p>
                    </div>
...
if (isset($_POST['submit'])) {
    ...
    $sql1 = "INSERT INTO `multiplayer`(`sportid`, `sportname`, `teamA`, `teamB`, `percentage`, `totalentry`, `time`, `totalCollected`, `winteam`, `winteamid`, `status`) VALUES 
    ('$sport','$sportname','$teama','$teamb','$percentage',0,'$time',0,'',0,1)";

    $queryRun = mysqli_query($con, $sql1);
    if ($queryRun) {
        header('Location: multiplayer.php?added=true');
    }
}
?>