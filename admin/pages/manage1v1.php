                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Add 1 Vs 1 Game</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            echo "
                                             ...
                                             <td>$winteam</td>
                                             <td>$status</td>
                                             <td><a href='delete.php?id=$row[0]&type=1v1' class='btn btn-danger'>Delete</td>
                                             <td><a href='close.php?id=$row[0]&type=1v1' class='btn btn-info'>Close</td>
