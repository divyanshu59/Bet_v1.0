            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Add 2 Vs 2 Game</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="container1" id="formbox">
                        <h2>Add 2 Vs 2 Game</h2>

                        <form action="2v2.php" method="post">
                        ...
                        <p id="resultText">
                            ...
                            if (isset($_GET['added'])) {
                               ...
                               <h3 class='text-success'>Multiplayer Game Added! </h3>
                                ";
                                echo '<a href="2v2.php" class="btn btn-success">Ok</a>';
                            }
                            ?>
                        </p>
                    </div>
...
if (isset($_POST['submit'])) {
    ...
    $sql1 = "INSERT INTO `2v2`(`sportid`, `sportname`, `teamA`, `teamB`, `percentage`, `totalentry`, `time`, `totalCollected`, `winteam`, `winteamid`, `status`) VALUES 
    ('$sport','$sportname','$teama','$teamb','$percentage',0,'$time',0,'',0,1)";

    $queryRun = mysqli_query($con, $sql1);
    if ($queryRun) {
        header('Location: 2v2.php?added=true');
    }
}
?>