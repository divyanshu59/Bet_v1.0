                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/managetoss.php">Manage Toss Game</a>
                                            <a class="nav-link" href="pages/managescore.php">Manage Score Gussing</a>
                                            <a class="nav-link" href="pages/manage1v1.php">Manage 1 Vs 1 Game</a>
                                            <a class="nav-link" href="pages/manage2v2.php">Manage 2 vs 2 Game</a>
                                            <a class="nav-link" href="pages/managemultiplayer.php">Manage Multiplayer Game</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"><?php echo $SiteName; ?> Dashboard</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
